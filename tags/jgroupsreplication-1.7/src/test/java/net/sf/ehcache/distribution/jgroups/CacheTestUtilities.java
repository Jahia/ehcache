...
public final class CacheTestUtilities {
     ...
     * JGroups
     */
    public static final URL ASYNC_CONFIG_URL1 = Thread.currentThread().getContextClassLoader()
            .getResource("distribution/jgroups/ehcache-distributed-jgroups-file-manager1.xml");
    /**
     * Config file 2
     */
    public static final URL ASYNC_CONFIG_URL2 = Thread.currentThread().getContextClassLoader()
            .getResource("distribution/jgroups/ehcache-distributed-jgroups-file-manager2.xml");
    /**
     * Config file 3
     */
    public static final URL ASYNC_CONFIG_URL3 = Thread.currentThread().getContextClassLoader()
            .getResource("distribution/jgroups/ehcache-distributed-jgroups-file-manager3.xml");
    /**
     * Config file 4
     */
    public static final URL ASYNC_CONFIG_URL4 = Thread.currentThread().getContextClassLoader()
